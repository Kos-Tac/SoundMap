...
public class AudioAnalyser : MonoBehaviour
{
    ...
    void AnalyzeSound()
    {
        ...
        if (UseMic)
            ...
            audioPlayer.GetComponent<AudioSource>().GetOutputData(samples, 0); // fill array with samples
        int i = 0;
        float sum = 0f;
        ...
        if (UseMic)
            ...
            audioPlayer.GetComponent<AudioSource>().GetSpectrumData(spectrum, 0, FFTWindow.BlackmanHarris);
